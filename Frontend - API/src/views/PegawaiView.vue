          ...
          <div class="flex justify-between items-center">
            <div>
              ...
              <p class="text-gray-600 dark:text-gray-400 mt-1">
                Kelola data pegawai perusahaan dengan pencarian dan paginasi
              </p>
            </div>
            <button
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <div class="flex-1">
              <input
                ...
                @input="handleSearch"
                type="text"
                placeholder="Cari pegawai berdasarkan nama, telepon, posisi..."
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10">
                      <div v-if="employee.image" class="h-10 w-10 rounded-full overflow-hidden">
                        <img
                          :src="employee.image"
                          :alt="employee.name"
        ...
        <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700">
          <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div class="text-sm text-gray-600 dark:text-gray-400">
              ...
              of {{ paginationInfo.totalItems }} employees
            </div>
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      @blur="validateField('division_id')"
                    >
                  ...
                  <div>
                    ...
                    />
                    <p v-if="formErrors.image" class="mt-1 text-sm text-red-600 dark:text-red-400">
                      {{ formErrors.image }}
                    </p>
                  </div>
                </div>
...
const validateField = (field: keyof FormErrors) => {
  ...
  switch (field) {
    ...
    case 'phone':
      if (!form.phone.trim()) {
        formErrors.phone = 'Telepon harus diisi'
      } else if (!/^[\d\s\-\+\(\)]+$/.test(form.phone)) {
        formErrors.phone = 'Format telepon tidak valid'
      }
      break
    case 'position':
      if (!form.position.trim()) {
        formErrors.position = 'Posisi harus diisi'
      }
      break
    case 'division_id':
      if (!form.division_id) {
        formErrors.division_id = 'Divisi harus dipilih'
      }
      break
  }
}
...
const validateForm = () => {
  ...
  validateField('division_id')
  if (form.image) validateField('image')
}
...
const fetchDivisions = async () => {
  try {
    ...
    divisions.value = response.data.data || response.data
  } catch (error: unknown) {
    console.error('Error fetching divisions:', error)
    toastStore.error('Gagal memuat data divisi', {
      title: 'Error',
      duration: 4000,
    })
  }
