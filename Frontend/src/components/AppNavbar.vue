      ...
      <div class="flex justify-between h-16">
        ...
        <div class="flex items-center">
          <router-link to="/" class="flex items-center space-x-2">
            <span class="text-xl font-bold text-gray-900 dark:text-white">Challange Test</span>
          </router-link>
        </div>
        ...
        <div class="hidden md:flex items-center space-x-8">
          ...
          <router-link
            ...
            class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors hover:bg-gray-100 dark:hover:bg-gray-700"
            :class="{
              '!text-blue-600 dark:!text-blue-400': $route.path.startsWith('/departemen'),
            }"
          >
            Departemen
          </router-link>
          <router-link
            ...
            class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors hover:bg-gray-100 dark:hover:bg-gray-700"
            :class="{
              '!text-blue-600 dark:!text-blue-400': $route.path.startsWith('/pegawai'),
            }"
          >
            Pegawai
          </router-link>
...
const handleLogout = async () => {
  try {
    ...
    closeMobileMenu()
    router.push('/login')
    toastStore.success('Logout successful')
  } catch (error) {
    console.error('Error during logout:', error)
    toastStore.error('Failed to logout. Please try again.')
    // Still close UI elements and redirect even if logout fails
    closeDropdown()
    closeMobileMenu()
    router.push('/login')
  }
